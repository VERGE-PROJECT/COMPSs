...
for img in $base_images; do
   docker buildx build --builder ${builder} --target base_${img} --platform ${platforms} ${flag} -t albabsc/compss-${base_name}_${img}:${BASE_VERSION} -t albabsc/compss-${base_name}_${img}:latest .
