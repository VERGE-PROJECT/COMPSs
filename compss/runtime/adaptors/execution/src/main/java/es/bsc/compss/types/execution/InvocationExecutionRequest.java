...
public class InvocationExecutionRequest extends ExecutorRequest {
    ...
    public void run(Executor executor) {
        try {
            ...
            executor.processInvocation(invocation, listener, p);
            this.listener.notifyEnd(this.invocation, true, null, p);
        } catch (COMPSsException ce) {
            this.listener.notifyEnd(this.invocation, false, ce, null);
        } catch (Exception e) {
            this.listener.notifyEnd(this.invocation, false, null, null);
        }
    }
    ...
    public static interface Listener {
         ...
         * @param p Profile containing execution time of tasks.
         */
        public void notifyEnd(Invocation invocation, boolean success, COMPSsException e, NIOProfile p);
