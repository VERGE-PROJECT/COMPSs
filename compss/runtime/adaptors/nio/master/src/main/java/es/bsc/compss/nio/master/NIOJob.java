...
public class NIOJob extends JobImpl<NIOWorkerNode> {
     ...
     * @param p Profile containing execution times of tasks.
     */
    public void taskFinished(boolean successful, NIOTaskResult ntr, Exception e, NIOProfile p) {
    ...
    private void completed(NIOTaskResult ntr, NIOProfile p) {
